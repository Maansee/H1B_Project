...
a4 = filter a1 by case_status =='WITHDRAWN';

a5 = group a4 by year;

--a6 = foreach a5 generate group as year, COUNT(a4) as Withdrawn;
a6 = load '/niit/a6_op_with' using PigStorage(',') as (year:chararray, a4_count:int);
